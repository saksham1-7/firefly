...
const require$1 = require$$1.createRequire((typeof document === 'undefined' ? require$$0.pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('constants.js', document.baseURI).href)));
...
const LAZY_ENV = () => {
  ...
  return Object.freeze({
    ...
    INLINED_SOCKET_CLI_COANA_TECH_CLI_VERSION: envAsString("15.10.45"),
    ...
    INLINED_SOCKET_CLI_VERSION: envAsString("1.1.176"),
    // Comp-time inlined Socket package version hash.
    // The '@rollup/plugin-replace' will replace "process.env['INLINED_SOCKET_CLI_VERSION_HASH']".
    INLINED_SOCKET_CLI_VERSION_HASH: envAsString("1.1.176:32e6133a2:796afa6e"),
...
//# debugId=26e22d1a-5ed2-44cf-b269-3f057a3dcc3b
